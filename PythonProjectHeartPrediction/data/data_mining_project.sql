...
INSERT INTO `patients_data_mining` (`patient_id`, `age`, `gender`, `chest_pain_type`, `resting_blood_pressure`, `cholesterol`, `max_heart_rate`, `exercise_angina`, `blood_sugar`, `diagnosis`) VALUES
	...
	(108, 23, 'F', 2, 124, 123, 123, 'Y', 1, 1),
	(109, 30, 'F', 2, 150, 300, 123, 'N', 1, 1),
	(110, 20, 'F', 1, 150, 400, 200, 'Y', 1, 1);
...
-- Dumping data for table data mining project.users: ~2 rows (approximately)
DELETE FROM `users`;
