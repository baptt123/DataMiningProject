...
CREATE TABLE patients_data_mining (
  ...
  shortness_of_breath varchar(10) DEFAULT NULL,
  fatigue varchar(10) DEFAULT NULL,
  dizziness varchar(10) DEFAULT NULL,
  chest_pain_frequency int(11) DEFAULT NULL,
  heart_rate_variability int(11) DEFAULT NULL,
...
INSERT INTO `patients_data_mining` (
  `patient_id`, `fullname`, `age`, `gender`, `chest_pain_type`, `resting_blood_pressure`, 
...
(9, 'a', 47, 'F', 2, 128, 250, 155, 'Y', 'Normal', 'None', 'Never', 'Often', 2, 28, 41, 2.0, 5, 'N', 0),
...
(16, 'a', 51, 'M', 3, 138, 400, 148, 'N', 'Normal', 'Severe', 'Often', 'Never', 3, 55, 63, 4.0, 7, 'N', 1),
...
(23, 'a', 65, 'F', 2, 160, 90, 100, 'N', 'Very High', 'Severe', 'Never', 'Never', 4, 60, 70, 5.0, 10, 'Y', 1),
...
(39, 'a', 32, 'M', 1, 110, 180, 200, 'Y', 'High', 'Severe', 'Often', 'Occasional', 4, 35, 48, 3.0, 7, 'Y', 1),
...
(47, 'a', 110, 'M', 4, 200, 1000, 200, 'Y', 'High', 'Severe', 'Often', 'Never', 4, 60, 80, 5.0, 10, 'Y', 1),
(48, 'a', 50, 'F', 1, 115, 150, 170, 'N', 'Normal', 'None', 'Never', 'Never', 1, 20, 35, 2.0, 3, 'N', 0),
...
(52, 'a', 25, 'F', 4, 125, 300, 160, 'N', 'Normal', 'Moderate', 'Never', 'Never', 2, 28, 42, 3.0, 5, 'N', 0),
...
(62, 'a', 40, 'M', 2, 120, 320, 160, 'Y', 'Normal', 'Moderate', 'Sometimes', 'Never', 3, 35, 48, 3.0, 7, 'Y', 1),
...
(70, 'a', 38, 'M', 3, 130, 400, 150, 'Y', 'Normal', 'Severe', 'Sometimes', 'Never', 3, 45, 60, 3.0, 6, 'Y', 1),
...
(74, 'a', 92, 'M', 2, 130, 900, 145, 'Y', 'Very High', 'None', 'Never', 'Never', 4, 55, 70, 4.0, 8, 'Y', 1),
...
(80, 'a', 47, 'M', 2, 110, 250, 165, 'Y', 'Normal', 'None', 'Sometimes', 'Never', 4, 35, 50, 3.0, 5, 'Y', 1),
...
(84, 'a', 95, 'M', 4, 150, 1000, 130, 'Y', 'High', 'None', 'Sometimes', 'Never', 3, 55, 70, 4.0, 9, 'Y', 1),
...
(92, 'a', 48, 'M', 3, 120, 370, 155, 'Y', 'Normal', 'Moderate', 'Sometimes', 'Never', 2, 33, 47, 3.0, 6, 'Y', 0),
...
(109, 'a', 30, 'F', 2, 150, 320, 123, 'N', 'High', 'Moderate', 'Sometimes', 'Often', 3, 40, 50, 3.0, 6, 'Y', 1),
(110, 'a', 20, 'F', 1, 150, 400, 200, 'Y', 'High', 'Severe', 'Often', 'Often', 4, 55, 63, 4.0, 9, 'Y', 1);
-- --------------------------------------------------------
